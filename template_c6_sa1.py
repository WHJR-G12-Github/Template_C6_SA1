...
while True:
  ...
  # Check if 'bulletState' is "fired"
  
      # Find new x,y coordinates of 'bullet' by calling 'newxy()' 
      # 'bullet.x','bullet.y','20','bangle' as arguments
      
  
  # Check if 'bullet.x' is less than 0 or greater than 400 or 'bullet.y' is less than 0 or greater than 600
